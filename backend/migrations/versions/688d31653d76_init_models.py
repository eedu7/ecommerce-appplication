...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_uid"], ["categories.uid"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("uid"),
        sa.UniqueConstraint("name"),
    )
    op.create_index(
        op.f("ix_categories_parent_uid"), "categories", ["parent_uid"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category_uid"], ["categories.uid"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("uid"),
    )
